...
export default class IngredientsMethodsTemplate {
  get(id) {
  ...
  addStock(quantity) {
    logger.error(
      "Método ADDSTOCK para los ingredientes ¡no imprelemtado!"
    );
  }

  removeStock(quantity) {
    logger.error(
      "Método REMOVESTOCK para los ingredientes ¡no imprelemtado!"
    );
  }
